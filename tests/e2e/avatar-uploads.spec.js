...
test.describe('Avatar Uploads and File Handling', () => {
  ...
  test.describe('Avatar Upload', () => {
    ...
    test('should support multiple image formats (PNG, JPG, GIF)', async ({ page }) => {
      ...
      const formats = [
        { ext: 'png', mime: 'image/png', buffer: 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==' },
        { ext: 'jpg', mime: 'image/jpeg', buffer: '' },
        { ext: 'gif', mime: 'image/gif', buffer: 'R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7' }
      ];
  ...
  test.describe('Avatar Display', () => {
    ...
    test('should display avatar in project collaborator list', async ({ page, request }) => {
      ...
      const hasAvatar = await ownerAvatar.first().isVisible().catch(() => false);
  ...
  test.describe('Security and Validation', () => {
    ...
    test('should sanitize filenames', async ({ page }) => {
      ...
      fs.writeFileSync(testPath, Buffer.from(
        'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
        'base64'
      ));
